...
class ed extends JFrame implements ActionListener
{
    ...
    ed(int n, int k)
    {
        ...
        String columns[] = {"Serial-no.","Employee Name","Phone-no.","Age","Gender","Login Password"};
        String datas[][] = new String[order][6];
        ...
        jt.getColumnModel().getColumn(4).setPreferredWidth(55);
